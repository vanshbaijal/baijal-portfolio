...
import "./home.css";
import CV from "../../assets/Vansh-CV.pdf";

const Data = () => {
    return (
        <div className="home__data container">
            <h1 className="home__title">Vansh Baijal
            {/* <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Front-end Enthusiast</h3>
            <p className="home__description">Hey there✌️</p>
